...
public class Connecting {
    ...
    public static void initDB() {
        ...
        String addUser = "INSERT INTO user(u_email, u_password, u_first_name, u_last_name)"
                ...
                + "('official1@mail.com', 'abcdef', 'Jean', 'Petit'),"
                + "('official2@mail.com', 'abcdef', 'Nicolas', 'Grand'),"
                + "('official3@mail.com', 'abcdef', 'Alice', 'Moyen'),"
                + "('official4@mail.com', 'abcdef', 'Léa', 'Dupuis'),"
                + "('official5@mail.com', 'abcdef', 'Romane', 'Dupont'),"
                + "('official6@mail.com', 'abcdef', 'Louis', 'Dufour'),"
